export const ActivityList = [
    {
        ...
        desc: "Worked together with the team to prepare slides, form headers, profile pictures, design merchandises, cue cards, and Instagram story frames alongside various other design needs for this event. This event was a selection for next year's Chairman of Keluarga Mahasiswa Katolik (KMK) BINUS."
    },
    {
    ...
    },
    {
        ...
        desc: "Worked on the proposal and final report of the event, added with handling the funds and budgeting of the event, which was an event to teach young people about IT. This year, we went to Bani Salam Orphanage in Bandung, West Java to introduce the concept of AI to the children."
    },
    {
        name: "Design and Documentation Committee of HIMTI Sesvent 2024",
        date: "October 12th, 2024",
        desc: "Designed the twibbon, logo animation and helping with the documentation for the event, which was an activist selection event."
    },
    {
    ...
    },
    {
        ...
        desc: "Took documentations for the online event in form of videos and pictures. In this event, students and researchers from various countries and regions, from Indonesia until Europe, presented their researches through virtual meeting."
    },
    {
